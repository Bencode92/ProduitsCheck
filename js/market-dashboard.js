  ...
  function _render(container) {
    ...
    (function () {
      ...
      html += '<style>' +
        ...
        '.rk-ex{margin-top:11px;padding:10px 12px;border:1px dashed ' + BG.border + ';border-radius:6px;background:' + BG.row1 + ';font-size:11.5px;line-height:1.65;color:' + BG.textDim + '}' +
        '.rk-ex b.h{display:block;font-family:var(--sans,inherit);font-size:9px;letter-spacing:.07em;text-transform:uppercase;margin-bottom:4px}' +
        '.rk-ex .n{font-family:var(--mono,ui-monospace,monospace);font-variant-numeric:tabular-nums;font-weight:700;color:' + BG.text + '}' +
      ...
      var rung = function (o) {
        ...
        h += o.body;
        if (o.ex) h += '<div class="rk-ex"><b class="h" style="color:' + o.color + '">Un exemple concret</b>' + o.ex + '</div>';
      ...
      html += rung({
        ...
        ex: 'Tu places <span class="n">300 000 €</span> pendant un an. Laissés à la BCE au taux de dépôt, ils rapporteraient <span class="n">7 500 €</span> — c\'est ce que ta banque obtient sans rien faire. Ton CAT à ' + (typeof _bestCatRate === 'function' ? '' : '') + '<span class="n">3,13 %</span> te verse <span class="n">9 390 €</span>. <strong>L\'écart de 1 890 €, c\'est exactement ce que la banque consent pour garder ton dépôt chez elle</strong> plutôt que de le laisser dormir à la BCE. Si la BCE baissait ses taux, cet écart serait le premier à disparaître.',
      ...
      html += rung({
        ...
        ex: 'Tu détiens un produit à taux fixe <span class="n">4 %</span> émis il y a deux ans, et tu veux sortir. La banque ne regarde pas ce que tu as payé : elle actualise les coupons qui restent avec la courbe d\'aujourd\'hui. Comme les taux ont monté depuis l\'émission, ces 4 % valent désormais moins qu\'un produit neuf — elle te rachètera <strong>sous 100</strong>. Même produit, même émetteur, même coupon : <strong>c\'est le taux d\'actualisation qui a bougé, pas ton contrat.</strong>',
      ...
      html += rung({
        ...
        ex: 'Un crédit d\'entreprise de <span class="n">500 000 €</span> indexé « Euribor 3 mois + 1,20 % ». Avec l\'Euribor 3 mois à <span class="n">2,51 %</span>, tu paies <span class="n">3,71 %</span>, soit <span class="n">18 550 €</span> par an. Si l\'Euribor prend 50 bp, ta charge passe à <span class="n">21 050 €</span> — <strong>sans qu\'une seule ligne de ton contrat ait changé</strong>. C\'est la même mécanique qui fait tomber ou non le coupon d\'un range accrual Euribor.',
      ...
      html += rung({
        facts: [
          ...
          ['Sur quoi', 'Deux parties <strong>échangent des flux d\'intérêts</strong> pendant N années, sur un montant qui <strong>ne change jamais de mains</strong>. L\'une paie un taux fixe, l\'autre un taux variable. Le taux fixe qui équilibre l\'échange, c\'est le taux swap à N ans.'],
        ...
        ex: 'Ton <strong>Range Accrual CMS 10 ans</strong> fait exactement ça : <strong>chaque jour</strong>, il regarde où se situe le taux swap 10 ans. Si ce jour-là il est <span class="n">entre 1,50 % et 3,35 %</span>, tu accumules un 365<sup>e</sup> du coupon ; sinon, rien du tout pour cette journée. Aujourd\'hui il est à <span class="n">' + P(cms10) + '</span> — <strong>au-dessus du plafond, donc la journée ne compte pas</strong>.<br><br>Et c\'est là que la confusion coûte cher : si tu avais regardé le TEC 10 (<span class="n">' + P(t10) + '</span>) en croyant lire « le taux 10 ans », tu aurais conclu que le produit est hors-jeu de ' + Math.round((t10 - 3.35) * 100) + ' bp. Le vrai écart est de <span class="n">' + Math.round((cms10 - 3.35) * 100) + ' bp</span>. <strong>Même nom, deux taux différents, deux conclusions différentes.</strong>',
        ...
        chips: swChips,
        body: '<strong>Le swap, en une phrase.</strong> Une entreprise a emprunté 10 M€ à taux variable et craint une hausse. Elle va voir une banque : « je te paie <span style="font-family:var(--mono,monospace)">' + P(cms10) + '</span> fixe chaque année pendant 10 ans, et toi tu me paies l\'Euribor ». Son crédit devient fixe. Les 10 M€ n\'ont jamais bougé — seuls les intérêts s\'échangent. <strong>Ce taux fixe, c\'est le taux swap 10 ans.</strong>' +
              '<br><br><strong>Le CMS, c\'est ce même taux, relevé plus tard.</strong> Le taux swap 10 ans change tous les jours. Un <strong>CMS 10 ans</strong> n\'est rien d\'autre que « le taux swap 10 ans, tel qu\'il sera constaté à telle date ».' +
              '<br><br><strong>Et voici la différence qui compte.</strong> L\'Euribor 3 mois que tu constateras dans cinq ans sera encore un taux à <em>3 mois</em>. Le CMS 10 ans que tu constateras dans cinq ans sera <strong>encore un taux à 10 ans</strong> : sa maturité ne raccourcit jamais. D\'où son nom — <em>Constant Maturity Swap</em>, maturité constante. C\'est ce qui permet de fabriquer un produit qui regarde les taux <strong>longs</strong> avec des constatations <strong>fréquentes</strong>, parfois quotidiennes.' +
              '<br><br><strong>Pourquoi c\'est la vraie courbe sans risque, et pas l\'OAT.</strong> Un swap ne prête aucun capital : seuls les intérêts s\'échangent. Il n\'y a donc presque pas de risque de crédit dedans — alors qu\'acheter une OAT, c\'est prêter 100 € à l\'État français pendant dix ans. C\'est pour ça que le marché price avec le swap, et que l\'OAT se traite au-dessus.' +
      ...
      html += rung({
        ...
        ex: 'Ton <strong>TARN TEC 10 Décembre 2035</strong> verse un coupon si le TEC 10 reste sous <span class="n">4,40 %</span>. Il est aujourd\'hui à <span class="n">' + P(t10) + '</span> : <strong>' + Math.round((t10 - 4.40) * 100) + ' bp trop haut, donc pas de coupon</strong> cette année. Note bien ce qu\'on regarde : ni l\'Euribor, ni le swap — <strong>le TEC, parce que c\'est lui que la fiche produit nomme</strong>. Un même niveau de « taux 10 ans » vaut 4,48 % en TEC et ' + P(cms10) + ' en swap : lire la mauvaise courbe change la réponse du tout au tout.',
