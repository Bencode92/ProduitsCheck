...
function _isRateExpired(r) { if (!r.date) return false; const d = new Date(r.date); if (isNaN(d.getTime())) return false; const ageDays = (new Date() - d) / 86400000; const maxAge = r.source === 'confirmed' ? 45 : 5; return ageDays > maxAge; }
